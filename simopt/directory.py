...
from simopt.models.smf import SMF, SMF_Max

# Import Solvers
from simopt.solvers.adam import ADAM
from simopt.solvers.adam_flexible_scaling import ADAM_FS
from simopt.solvers.adam_doe import ADAM_DOE
from simopt.solvers.adam_pro import ADAM_PRO
...
problem_directory: dict[str, type[Problem]] = {
    ...
    "AMBULANCE-1": AmbulanceMinAvgResponse,
    "SMF-1": SMF_Max,
}
...
problem_unabbreviated_directory: dict[str, type[Problem]] = {
    ...
    "Min Avg Response Time for Ambulance Dispatch": AmbulanceMinAvgResponse,
    "Stochastic Max-Flow network (SBDG)": SMF_Max
}
...
model_problem_unabbreviated_directory: dict[str, str] = {
    ...
    "Min Total Departed Visitors for Amusement Park (SDDN)": "AMBULANCE",
    "Stochastic Max-Flow network (SBDG)": "SMF"
}
model_problem_class_directory: dict[str, type[Model]] = {
    ...
    "Min Total Cost for Communication Networks System (SDCN)": Network,
    "Min Total Departed Visitors for Amusement Park (SDDN)": AmusementPark,
    "Min Avg Response Time for Ambulance Dispatch": Ambulance,
    "Stochastic Max-Flow network (SBDG)": SMF
}
model_unabbreviated_directory: dict[str, type[Model]] = {
    ...
    "Stochastic Max-Flow Network": SMF
}
